                    ...
                    <div class="col-sm-12">
                        <div class="beta-products-list">
                            ...
                            <div class="beta-products-details">
                                <p class="pull-left">Tìm thấy $sl sản phẩm</p>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="product.jsp"><img src="assets/dest/images/products/1.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Name Product</p>
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-header">
                                            <a href="product.jsp"><img src="assets/dest/images/products/2.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Name Product</p>
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="product.jsp"><img src="assets/dest/images/products/3.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Name Product</p>
